...
| `infiniteSession`                          | Saját kérést nem küld. A tárgyfelvételi oldalon, ha az oldal 12,5 perce nem küldött saját API-kérést, megnyomja a Neptun saját `#filter-table` gombját, és a Neptun maga frissít; más oldalon nem csinál semmit.                                                                                                                                                                                                                                                                                                                                                                                                                    |
